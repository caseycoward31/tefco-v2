...
async function logout() {
  ...
  return (
    <div style={{ background: '#090d10', color: 'white', minHeight: '100vh', display: 'flex' }}>
      <aside style={{ width: 220, background: '#111820', padding: 20 }}>
        <h2>TEFCO V2</h2>
        ...
        {page === 'admin' && (
          <>
            ...
            >
              <div>
                <h1 style={{ margin: 0, fontSize: 28 }}>
                  Admin <span style={{ color: companyAccentColor }}>/</span> Settings
                </h1>
                <p style={{ opacity: 0.7, marginTop: 6 }}>
                  Company setup, branding, users, roles, and contract configuration.
                </p>
              </div>
              ...
              >
                {getCompanyLogoUrl() ? (
                  ...
                  <div
                    style={{
                      ...
                      height: 42,
                      borderRadius: 999,
                      background: `linear-gradient(135deg, ${companyAccentColor}, #7a3b18)`,
                      display: 'flex',
                      alignItems: 'center',
                ...
                <div>
                  ...
                  <div style={{ fontSize: 12, opacity: 0.7 }}>{currentUserRole}</div>
                </div>
              </div>
            </div>
            ...
            <div
              style={{
                ...card,
                border: `1px solid ${companyAccentColor}`,
                background:
                  'linear-gradient(135deg, rgba(196,106,43,0.12), rgba(15,23,42,0.9))',
                marginBottom: 18,
              }}
            >
            ...
            >
              <div style={adminPanel}>
                <h2 style={sectionTitle}>Company Branding & Theme</h2>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '140px 1fr', gap: 16, alignItems: 'center' }}>
                  ...
                  >
                    ...
                    <div style={{ textAlign: 'center' }}>
                      <strong style={{ color: companyAccentColor }}>Upload Logo</strong>
                      <div style={{ fontSize: 12, opacity: 0.7 }}>PNG or JPG recommended</div>
                    </div>
                  </label>
                </div>
                ...
                <div style={{ marginTop: 12 }}>
                  ...
                  <div style={{ display: 'flex', gap: 10, marginTop: 10 }}>
                    {['#c46a2b', '#2563eb', '#14b8a6', '#9333ea', '#e11d48', '#64748b'].map((color) => (
                      <button
                        key={color}
                        onClick={() => setCompanyAccentColor(color)}
                        style={{
                          width: 34,
                          height: 34,
                          borderRadius: 999,
                          background: color,
                          border: companyAccentColor === color ? '3px solid white' : '1px solid rgba(255,255,255,0.2)',
                          cursor: 'pointer',
                        }}
                      />
                    ))}
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10, marginTop: 14 }}>
                  <button
                    style={{
                      ...adminButton,
                      background: companyThemeMode === 'dark' ? `linear-gradient(135deg, ${companyAccentColor}, #7a3b18)` : '#111827',
                    }}
                    onClick={() => setCompanyThemeMode('dark')}
                  >
                    Dark
                  </button>
                  <button
                    style={{
                      ...adminButton,
                      background: companyThemeMode === 'light' ? `linear-gradient(135deg, ${companyAccentColor}, #7a3b18)` : '#111827',
                    }}
                    onClick={() => setCompanyThemeMode('light')}
                  >
                    Light
                  </button>
                </div>

                <button style={{ ...adminButton, marginTop: 14 }} onClick={saveCompanySettings}>
                  Save Branding & Theme
                </button>
              </div>

              <div style={adminPanel}>
                <h2 style={sectionTitle}>Super Admin: Companies</h2>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr auto', gap: 10 }}>
                  ...
                  <button style={adminButton} onClick={createCompany}>
                    Create Company
                  </button>
                </div>
                ...
                <div style={{ marginTop: 18, paddingTop: 18, borderTop: '1px solid rgba(255,255,255,0.12)' }}>
                  ...
                  <button style={adminButton} onClick={createCompanyAdminUserUser}>
                    ...
                    {companies.map((company) => (
                      ...
                      >
                        ...
                        <div>
                          ...
                          <div style={{ fontSize: 11, opacity: 0.65 }}>ID: {company.id}</div>
                        </div>
                        <span
                          style={{
                            color: '#22c55e',
            ...
            <div style={adminPanel}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1.2fr 1.2fr 1fr auto', gap: 10 }}>
                <input
                  style={adminInput}
                ...
                <button style={adminButton} onClick={createAppUser}>
                  Create User
                </button>
              </div>
                  ...
                  {userRoles.map((role) => (
                    <div
                      ...
                      style={{
                        ...card,
                        display: 'grid',
                        gridTemplateColumns: '42px 1fr 120px auto',
                        gap: 12,
                        alignItems: 'center',
                      }}
                    >
                      ...
                      <div>
                        ...
                        <div style={{ fontSize: 11, opacity: 0.65 }}>User ID: {role.user_id}</div>
                      </div>
                      ...
                      {role.active !== false && (
                        <button
                          style={{ ...adminButton, background: '#991b1b', borderColor: '#ef4444' }}
            ...
            <div style={adminPanel}>
              <button
                style={{ ...adminButton, width: '100%', justifyContent: 'space-between' }}
              ...
              {showContractProfiles && (
                <div style={{ marginTop: 14 }}>
                  <h2 style={sectionTitle}>Contract Profiles</h2>
                  ...
                  <select style={adminInput} value={newProfileProducerId} onChange={(e) => setNewProfileProducerId(e.target.value)}>
                  ...
                  <button style={adminButton} onClick={createContractProfile}>
            ...
            <div style={adminPanel}>
              <button
                style={{ ...adminButton, width: '100%' }}
                onClick={() => setShowCompanySetupHub(!showCompanySetupHub)}
              >
                {showCompanySetupHub ? '▼' : '▶'} Company Setup Hub
              </button>

              {showCompanySetupHub && (
                <div style={{ marginTop: 14 }}>
                  <p style={{ opacity: 0.72 }}>
                    Manage areas, segments, leases, producers, meters, users, and contract profiles.
                  </p>

                  <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(150px,1fr))', gap: 10 }}>
                    <button style={adminTile} onClick={() => setPage('areas')}>Manage Areas</button>
                    <button style={adminTile} onClick={() => setPage('segments')}>Manage Segments</button>
                    <button style={adminTile} onClick={() => setPage('leases')}>Manage Leases</button>
                    <button style={adminTile} onClick={() => setPage('producers')}>Manage Producers</button>
                    <button style={adminTile} onClick={() => setPage('meters')}>Manage Meters</button>
                  </div>
                </div>
              )}
            </div>
