...
function calculateApi11Corrections(input: {
  ...
  return {
    ...
    api_gravity_60: roundTo(base.apiGravity60, 5),
      ...
      <html>
        ...
        <body>
          ...
          <div class="box">
            ...
            <div class="row"><strong>API Gravity @60</strong><span>${ticket.observed_inputs?.api_gravity_60 ?? ticket.api_gravity_60 ?? ''}</span></div>
