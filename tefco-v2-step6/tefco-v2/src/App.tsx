...
const graphiteButton: CSSProperties = {
...
const graphiteCard: CSSProperties = {
  background: graphiteTheme.panel,
  border: `1px solid ${graphiteTheme.border}`,
  borderRadius: 16,
  padding: 18,
  boxShadow: '0 18px 40px rgba(0,0,0,0.32)',
  color: graphiteTheme.text,
}

const graphiteInput: CSSProperties = {
  width: '100%',
