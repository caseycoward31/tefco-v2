          ...
          <>
            ...
            {(isSuperAdmin || userRoles.length === 0) && (
              <div style={box}>
                ...
                <button style={copperButton} onClick={createCompany}>
                  Create Company
                </button>
                ...
                <div style={{ marginTop: 20 }}>
                  ...
                  <button style={copperButton} onClick={createCompanyAdminUserUser}>
            ...
            <div style={box}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(170px,1fr))', gap: 10 }}>
                <button style={copperButton} onClick={() => setPage('areas')}>Manage Areas</button>
                <button style={copperButton} onClick={() => setPage('segments')}>Manage Segments</button>
                <button style={copperButton} onClick={() => setPage('leases')}>Manage Leases</button>
            ...
            <div style={box}>
              <button
              style={{ ...copperButton, marginBottom: 12 }}
...
const copperButton: CSSProperties = {
  ...button,
  background: 'linear-gradient(135deg, #b65f2a, #7a3b18)',
  color: '#fff',
  border: '1px solid #d47a3a',
  boxShadow: '0 0 14px rgba(182, 95, 42, 0.25)',
}
